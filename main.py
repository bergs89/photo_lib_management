...
def preprocess_pictures2import(_directory,
    ...
    if not (find_duplicates and find_blurry) and delete_duplicates_and_blurry:
        print("I cannot delete duplicates and blurry if you do not let me search for them")

    if find_duplicates and find_blurry and delete_duplicates_and_blurry:
